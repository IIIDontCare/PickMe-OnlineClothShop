...
<body>
	...
	<div id="mainmenu" class="leftcolumn" style="cursor:url('poro.cur'),auto;">
			...
			<a class="bar-item" style="font-size:15pt; background-color:rgba(61, 139, 173, 0.8);">Jackets</a>
			</div>
	...
	<div id="itemcondition" class="content" style="cursor:url('poro.cur'),auto;">
		...
		<br><br>
		<!--標題-->
		<div style="text-align:center; font-family:Hastoler;"><font size="7"><strong> ~ ~ ~ JACKETS ~ ~ ~ </strong></div>
		<br>
	...
	<?php
		...
		$select="SELECT * FROM clothes WHERE category='jacket'";
		$data=mysqli_query($conn,$select);//從member中選取全部(*)的資料
		$sql=sprintf("SELECT * FROM clothes WHERE category='jacket' ORDER BY cnum");
		...
		<div class="w3-modal-content w3-animate-zoom">
			...
			<div class="w3-container">
				...
				<div class="modal-footer">
					<div id="div_test" style="font-family:SetoFont;display:none;color:white;position:absolute;z-index:100;left:50%;top:43%;margin-left:-75px;text-align:center;background-color:rgba(255, 153, 153,0.5);font-size:40px;">
						已加入購物車!
					</div>
					<form id="form1" action="" method="post" enctype="multipart/form-data" target="exec_target"><!--將資訊傳給自己-->
					<select style="font-family:SetoFont; font-size:15pt; " name="shopbox">
					...
					<input type="button" onclick="operate()" style="background-color:rgba(61, 139, 173, 0.3);border:0;font-family:SetoFont;font-size:25px;width:150px;height:40px;right:0;top:-10%;" value="加入購物車">
			...
			<div class="w3-container">
				...
				<font color="#025648"><b style="font-family:SetoFont;">我覺得這件...</b></font> <input type="text" style="height:50px;width:830px;" name="message"required><br><br>
				<input type="button" onclick="mess()" style="font-size:15pt;font-family:SetoFont; background-color:rgba(61, 139, 173, 0.3);border:0;margin-bottom:10px;" value="回覆">
