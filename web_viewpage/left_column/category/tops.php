...
<body>
	...
	<div id="mainmenu" class="leftcolumn" style="cursor:url('poro.cur'),auto;">
			...
			<a class="bar-item" style="font-size:15pt; background-color:rgba(61, 139, 173, 0.8);">Tops</a>
	...
	<div id="itemcondition" class="content" style="cursor:url('poro.cur'),auto;">
		...
		<br><br>
		<!--標題-->
		<div style="text-align:center; font-family:Hastoler;"><font size="7"><strong> ~ ~ ~ TOPS ~ ~ ~ </strong></div>
		<br>
	...
	<?php
		...
		$select="SELECT * FROM clothes WHERE category='top'";
		$data=mysqli_query($conn,$select);//從member中選取全部(*)的資料
		$sql=sprintf("SELECT * FROM clothes WHERE category='top' ORDER BY cnum");
