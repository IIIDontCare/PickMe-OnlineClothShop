...
<body>
	...
	<div id="mainmenu" class="leftcolumn">
			...
			<a class="bar-item" style="font-size:15pt; background-color:rgba(61, 139, 173, 0.8);">Comments</a>
			</div>
	...
	<div id="itemcondition" class="content">
		...
		?>
		<div style="font-family:SetoFont; background-color:rgba(235, 235, 224,0.8); width:800px;height:auto;padding-left:20px;padding-top:10px;padding-bottom:10px;border-radius:10px;margin-top:20px;margin-left:10px;"><font size="3">
			<font color="#3d8bad"><?php echo $row[0]?></font>
			<font color="black"> 認為商品 </font>
			<font color="#3d8bad"><?php echo $row2[0]?></font>
